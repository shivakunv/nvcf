module github.com/NVIDIA/nvcf/src/compute-plane-services/worker-llm-credentials

go 1.25.0

require (
	github.com/NVIDIA/nvcf/src/libraries/go/lib v0.0.0-20260919004556-7f28ae8c7368
	github.com/NVIDIA/nvcf/src/libraries/go/worker v0.0.0-20260919004556-7f28ae8c7368
