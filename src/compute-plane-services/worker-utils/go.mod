module github.com/NVIDIA/nvcf/src/compute-plane-services/worker-utils

go 1.26.0

require (
	github.com/NVIDIA/nvcf/src/libraries/go/lib v0.0.0-20260924163812-3414c0333e45
	github.com/NVIDIA/nvcf/src/libraries/go/worker v0.0.0-20260924163812-3414c0333e45
